   ...
   <div id="page-inner">
      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <h4>Total Genre: <?php echo $this->Paginator->counter('{{count}}'); ?></h4>
                     ...
                     <div id="searchDivOptions" style="display:block;">
                        ...
                        <div class="col-md-2">
                        	...
                        	<?php $title = $this->request->getQuery('title'); ?>
                              ...
                              'value' => isset($title)?$this->request->getQuery('name'):''
                        ...
                        <?php
                           	...
                           	echo $this->Html->link('Add Genere',

                           	array('plugin' => 'Admins', 'controller' => 'Ecommerce', 'action' => 'addGenre'),
                  ...
                  <div class="table-responsive">
                     ...
                     <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                           ...
                           <?php if(isset($genres) && !empty($genres) && $genres->count()>0){ 
                           ...
                           <tr class="odd gradeX">
                              ...
                              <td align="center">
                                 ...
                                 <button id="buttonId_<?php echo $val->id; ?>" onclick="changeStatus('Genres',<?php echo $val->id; ?>,<?php echo $val->status; ?>)" title= "Click here to Deactive" class="btn btn-info btn-circle"><i class="fa fa-check"></i></button>

                                 <?php } else { ?>

                                 <button id="buttonId_<?php echo $val->id; ?>" onclick="changeStatus('Genres',<?php echo $val->id; ?>,<?php echo $val->status; ?>)" title= "Click here to Active" class="btn btn-warning btn-circle"><i class="fa fa-times"></i></button>
                              ...
                              <td width="25%">
                                 <?php
                                    ...
                                    echo $this->Html->link('<i class="fa fa-edit "></i> Edit',
                                    	...
                                    	array('plugin' => 'Admins', 'controller' => 'Ecommerce', 'action' => 'addGenre',$val->id),
                                 ...
                                 <button class="btn btn-danger" onclick="deleteRecord('Genres',<?php echo $val->id; ?>,0);" ><i class="fa fa-pencil"></i> Delete</button>
...
<script type="text/javascript">
	...
	function searchData(){
		...
		window.location.href="<?php echo $this->Url->build('/admins/ecommerce/generes/'); ?>";	
