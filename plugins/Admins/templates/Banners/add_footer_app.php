...
<div id="page-wrapper" >
   ...
   <div id="page-inner">
      <div class="row">
         <div class="col-md-12">
         	<?php $type = 'Add'; if(isset($apps->id)){$type = 'Edit';} ?>
            <h2><?php echo $type; ?> Footer App</h2>
         ...
         <div class="col-md-12">
            ...
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <div class="row">
                     <div class="col-md-6">
                        <?php echo $this->Form->create($apps,array('id' => 'addForm', 'csrfToken' => $this->request->getAttribute('csrfToken'))); ?>
                        ...
                        <div class="form-group">
                        	<?php $appsType = ['TV'=>'TV', 'Mobile'=>'Mobile'] ?>                        	
                        ...
                        <div class="form-group">
                           ...
                           <div class="msg2">                            
                              <?php
                                 if(!empty($apps['icon'])){
                                 	if(file_exists(WWW_ROOT.'img/banners/'.$apps['icon'])){
                                 		 echo $this->Html->image('banners/'.$apps['icon'], [
                                 			'alt'=>$apps['icon'],
                                 			'title' => $apps['icon'],
                                 			'width'=>'100']
                                 		);
...
function banner_image(){
	...
	if(manish == 1){
		...
		formData.append('model', 'FooterApps');
