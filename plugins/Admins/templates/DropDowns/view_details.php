<?php $userData = $this->User->getSingleRecordByEmail($detail->email);?>
<td colspan="8">
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-lg-12 col-xs-12" style="padding-left: 30px;">
            ...
            <p>	
                ...
                <div class="heading_text_style"><strong>User Profile Picture:</strong></div>

                <div class="name_style"> <?php echo $this->Html->image('user/' . $userData->profile, ['alt' => $userData->profile, 'title' => $userData->profile, 'width' => '100']); ?></div>
                ...
                <?php if(isset($userData->id)){?>
                <div class="heading_text_style"><strong>City/Location:</strong></div>

                <div class="name_style"> <?php echo isCheckVal($userData->city); ?></div>
