...
<div id="page-wrapper" >
   ...
   <div id="page-inner">
      <div class="row">
         <div class="col-md-12">
         	<?php $type = 'Add'; if(isset($member->id)){$type = 'Edit';} ?>
      ...
      <?php
			echo $this->Html->link('Back',
				array('plugin' => 'Admins', 'controller' => 'drop-downs', 'action' => 'members'),
         ...
         <div class="col-md-12">
            ...
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <div class="row">
                     <div class="col-md-6">
                        <?php echo $this->Form->create($member,array('id' => 'addForm','csrfToken' => $this->request->getAttribute('csrfToken'))); ?>
                           ...
                           <div class="msg2">                            
                              <?php
                                 if(!empty($member['profile'])){
                                  if(file_exists(WWW_ROOT.'img/members/'.$member['profile'])){
                                    echo $this->Html->image('members/'.$member['profile'], [
                                      'alt'=>$member['profile'],
                                      'title' => $member['name'],
                                      'width'=>'100']
                                    );
