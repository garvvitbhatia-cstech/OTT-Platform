   ...
   <div id="page-inner">
      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <h4>Total Users: <?php echo $this->Paginator->counter('{{count}}'); ?></h4>
                  ...
                  <div class="row">
                     ...
                     <div id="searchDivOptions" style="display:block;">
                        ...
                        <div class="col-md-1">
                           ...
                           <?php $city = $this->request->getQuery('city'); ?>
                           ...
                           <?php echo $this->Form->control('city',
              						   			...
              						   			array(
              										...
              										'value' => isset($city) ? $this->request->getQuery('city') : ''));
                        ...
                        <div class="col-md-2">
                           ...
                           <?php $subscriptionStatus = $this->request->getQuery('subscription_status'); ?>

                           <?php echo $this->Form->control('subscription_status',
            						   			...
            						   			array(
            										...
            										'empty' => 'Subscription',
            										'class' => 'form-control filter-input',
            										'value' => isset($subscriptionStatus) ? $this->request->getQuery('subscription_status') : ''));
                        ...
                        <div class="col-md-2">
                           ...
                           <?php echo $this->Form->control('is_film_maker',
                        ...
                        <?php
                           	...
                           	array('plugin' => 'Admins', 'controller' => 'Users', 'action' => 'addUser'),
                        ...
                        <tbody>
                           ...
                           <tr class="odd gradeX">
                              ...
                              <td <?php if($val->subscription_status == 'Paid'){?> style="background:#093;color:#FFF" <?php } ?>>
								...
								<?php if($val->is_film_maker == 1){echo 'Film Maker';}?>
                                <?php echo isCheckVal($val->subscription_status); ?> Member<br>
                                <?php if($val->subscription_status == 'Paid'){ ?>
                                <?php $packDetail = $this->Setting->getPackageDetails($val->package_id);  
								if(isset($packDetail->title)){
								 echo $packDetail->title.'<br>';
							  	}
								 ?>
                                <?php } ?>

                                <?php if($val->pack_start_date != ""){?>Start Date: <?php echo(date("F jS, Y",$val->pack_start_date)); ?><br /><?php } ?>

                                 <?php if($val->pack_end_date != ""){?>End Date: <?php echo(date("F jS, Y",$val->pack_end_date)); ?><br /><?php } ?>

                                Created at: <?php echo date("F jS, Y",$val->created); ?>
                              ...
                              <td>
                                ...
                                <?php
        							...
        							echo $this->Html->link('<i class="fa fa-edit "></i> Edit', array('plugin' => 'Admins', 'controller' => 'Users', 'action' => 'addUser', base64_encode($val->id)), array('escape' => false, 'title' => 'Click here to edit record', 'class' => "btn btn-primary", 'data-placement' => "top", 'data-toggle' => "tooltip", 'type' => "button", 'data-original-title' => "Click here to edit record"));
...
<script type="text/javascript">
   ...
   function searchData(){
      ...
      window.location.href="<?php echo $this->Url->build('/admins/users/users/'); ?>";
