...
<th scope="col" colspan="2"></th>
  ...
  $content = $sendEmailData['userData'];
  ?>
  <tr>
    <td colspan="2" style="padding:20px 15px 10px;font-family:Verdana, Geneva, sans-serif; color:#424242; font-size:13px;font-weight:400;">Dear <?php e(ucwords($content['username'])); ?>,</td>
  </tr>
  <tr>
    ...
    <p style="font-size:14px; color: #424242;"><?php e($content['description']); ?></p> 
  </td>
  </tr>
