...
<th scope="col" colspan="2"></th>
  ...
  <tr>
   ...
   <tr>
 <td colspan="2" style="padding:5px 15px 15px;font-family:Verdana, Geneva, sans-serif; color:#424242; font-size:13px; line-height:20px;font-weight:400;">Your Password: <?php echo $userDetails['temp']; ?></td>
</tr>
