                            ...
                            <table style="width: 100%;border: 1px solid #484848;font-family: tahoma;border-collapse: collapse;;border-style: hidden;box-shadow: 0 0 0 1px #484848;-webkit-font-smoothing: antialiased;">
                                <tr style="border-bottom: 1px solid #484848;">
                                 ...
                                 <tr style="border-bottom: 1px solid #484848;">
                                    ...
                                    <td style="padding: 10px; color: #484848; font-size: 13px;">NaN</td>
                                    <td></td>
                                 </tr>
                                 <tr style="border-bottom: 1px solid #484848;">
                                 ...
                                 <tr style="border-bottom: 1px solid #484848;">
                                    <td style="padding: 10px; color: #484848; font-size: 13px; padding-left: 40px;">Payment Status:</td>
                                    <td style="padding: 10px; color: #484848; font-size: 13px;">Failed</td>
                                    <td></td>
                                 </tr>
