                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top: 20px;">
                    ...
                    <tbody>
                        ...
                        <br /><br /><br />
                            ...
                            <table style="width: 100%;border: 1px solid #484848;font-family: tahoma;border-collapse: collapse;border-radius: 5px;border-style: hidden;box-shadow: 0 0 0 1px #484848;-webkit-font-smoothing: antialiased;">
                            
							<?php
                            
                            if (!empty($profile)) {
                            if (file_exists(WWW_ROOT . 'img/user/' . $profile)) { ?>
                            
                            <tr style="border-bottom: 1px solid #484848;">
                            <td colspan="3" align="center"><?php echo $this->Html->image(SITEURL.'img/user/' . $profile, ['alt' => $profile, 'title' => $profile, 'width' => '100']); ?></td>
                            </tr>
                            ...
                            ?>
                                 ...
                                 <tr style="border-bottom: 1px solid #484848;">
                                    <td style="padding: 10px; color: #484848; font-size: 13px; padding-left: 40px;">Full Name:</td>
                                    <td style="padding: 10px; color: #484848; font-size: 13px;"><?php echo ucfirst($username);?></td>
                                    <td></td>
                                 </tr>
                                 
                                  <tr style="border-bottom: 1px solid #484848;">
                                    <td style="padding: 10px; color: #484848; font-size: 13px; padding-left: 40px;">Email Address:</td>
                                    <td style="padding: 10px; color: #484848; font-size: 13px;"><?php echo $emailAddress; ?></td>
                                    <td></td>
                                 </tr>
                                 <tr style="border-bottom: 1px solid #484848;">
                                    <td style="padding: 10px; color: #484848; font-size: 13px; padding-left: 40px;">Phone:</td>
                                    <td style="padding: 10px; color: #484848; font-size: 13px;"><?php echo $phone; ?></td>
                                    <td></td>
                                 </tr>
                                <tr style="border-bottom: 1px solid #484848;">
                                    <td style="padding: 10px; color: #484848; font-size: 13px; padding-left: 40px;">City:</td>
                                    <td style="padding: 10px; color: #484848; font-size: 13px;"><?php echo $city; ?></td>
                                    <td></td>
                                 </tr>
                            </table>
                            <br /><br />
