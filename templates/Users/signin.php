        ...
        <ott-signin _nghost-ovl-c59="" class="ng-star-inserted">
          ...
          <a href="<?php echo $this->Url->build('/'); ?>"><img _ngcontent-ovl-c59="" class="logo" tabindex="0" src="<?php echo $this->Url->build('/img/logo.png'); ?>"></a>
            <div _ngcontent-ovl-c59="" class="signin_inner ng-star-inserted">
              ...
              <h2 _ngcontent-ovl-c59="">Sign in to your Account </h2>
              
              <?php echo($this->Flash->render()); ?>

              <?= $this->Form->create(NULL,array('id' => 'regForm', 'action' => SITEURL.'user-login', 'csrfToken' => $this->request->getAttribute('csrfToken')));?>
                ...
                <div _ngcontent-ovl-c59="" class="form_rows">
                  ...
                  <input _ngcontent-ovl-c59="" oncopy="return false" onpaste="return false" id="password" name="password" onkeyup="$('#passwordError').html('');" class="form-control ng-untouched ng-pristine ng-invalid" type="password">
                  <span class="form_error_msg" id="passwordError"></span>
                  <span _ngcontent-ovl-c59="" onclick="showPassword();" id="showHide" class="show_password">Show</span>

                  <div _ngcontent-ovl-c59="" class="link_wrap"><a _ngcontent-ovl-c59="" routerlink="/auth/forgot-password" href="<?php echo $this->Url->build('/forgot-password/'); ?>">Forgot Password?</a></div>
                  </label>

                </div>

                <button _ngcontent-ovl-c59="" id="signInButton" class="btn btn-grey">Sign In</button>
              ...
              <ott-social-login _ngcontent-ovl-c59="" _nghost-ovl-c56="">
                ...
                <div _ngcontent-ovl-c56="" class="row remove-margin social-login ng-star-inserted">
                  ...
                  <button _ngcontent-ovl-c56="" onclick="fbLogin();" class="facebook-login"><img _ngcontent-ovl-c56="" src="<?php echo $this->Url->build('/img/facebook_logo.png'); ?>"><span _ngcontent-ovl-c56="">Sign in with Facebook</span></button>
              ...
              <p _ngcontent-ovl-c59="" class="msg">By Signing in, you agree to Cinemasthan <a _ngcontent-ovl-c59="" target="_blank" href="<?php echo $this->Url->build('/terms-and-conditions/'); ?>"> Terms and Conditions</a></p>

              <span _ngcontent-ovl-c59="" class="have_an_account">Don't have an account? <a _ngcontent-ovl-c59="" class="signin" href="<?php echo $this->Url->build('/sign-up/'); ?>">Sign Up</a></span></div>
...
$(document).ready(function(e) {
    $('#signInButton').click(function(e) {
		...
		if(nitam == 1){
			$('#signInButton').html('Processing...');
			$('#regForm').submit();
		}
    });
});
function showPassword(){
 var showHideText = $('#showHide').html();
