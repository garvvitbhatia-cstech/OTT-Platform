              ...
              <div _ngcontent-kgi-c53="" class="container-fluid ng-tns-c53-397">
                <div _ngcontent-kgi-c53="" class="inner-container ng-tns-c53-397">
                  <div _ngcontent-kgi-c53="" class="setting__details ng-tns-c53-397"> <?php echo($this->Flash->render()); ?>
                    <h2 _ngcontent-kgi-c53="" class="account-info ng-tns-c53-397 accordion-item--isOpen">Submit Your Film</h2>
                    <div _ngcontent-kgi-c53="" class="user__details clearfix ng-tns-c53-397 ng-trigger ng-trigger-accordionItemContentAnimation" style="">
                      ...
                      <div _ngcontent-kgi-c53="" class="user__details__inner ng-tns-c53-397">
                        ...
                        <div _ngcontent-kgi-c53="" class="form-group ng-tns-c53-397">
                          ...
                          <option value="<?php echo $vals->id;?>"><?php echo ucwords($vals->name); ?></option>
                          <?php endforeach; ?>
                          </select>
                        ...
                        <div _ngcontent-kgi-c53="" class="form-group ng-tns-c53-397">
                          ...
                          <input id="product_name" onkeyup="$('#product_nameError').html('');" name="product_name" type="text" />
                        ...
                        <div _ngcontent-kgi-c53="" class="form-group ng-tns-c53-397">
                          ...
                          <input id="production_year" onkeyup="$('#production_yearError').html('');" name="production_year" type="text" />
                          <span class="form_error_msg" id="production_yearError"></span> 
                        </div>
                        
                        <div _ngcontent-kgi-c53="" class="form-group ng-tns-c53-397">
                          <label _ngcontent-kgi-c53="" class="ng-tns-c53-397">Language*</label>
                          <input id="language" onkeyup="$('#languageError').html('');" name="language" type="text" />
                        ...
                        <div _ngcontent-kgi-c53="" class="form-group ng-tns-c53-397">
                          ...
                          <option value="<?php echo $vals->title;?>"><?php echo ucwords($vals->title); ?></option>
                          <?php endforeach; ?>
                          </select>
                        ...
                        <div _ngcontent-kgi-c53="" class="form-group ng-tns-c53-397">
                          ...
                          <textarea name="keywords" id="keywords" class="select_multiple"></textarea>
                          <span class="form_error_msg" id="keywordsError"></span> 
                        </div>
                        
                        <div _ngcontent-kgi-c53="" class="form-group ng-tns-c53-397">
                          <label _ngcontent-kgi-c53="" class="ng-tns-c53-397">Trailer Video Link*</label>
                          <input id="trailer_video" onkeyup="$('#trailer_videoError').html('');" name="trailer_video" type="text" />
                        ...
                        <div _ngcontent-kgi-c53="" class="form-group ng-tns-c53-397">
                          ...
                          <input id="trailer_video_password" onkeyup="$('#trailer_video_passwordError').html('');" name="trailer_video_password" type="text" />
                        ...
                        <div _ngcontent-kgi-c53="" class="form-group ng-tns-c53-397">
                          ...
                          <input id="video" onkeyup="$('#videoError').html('');" name="video" type="text" />
                        ...
                        <div _ngcontent-kgi-c53="" class="form-group ng-tns-c53-397">
                          ...
                          <input id="video_password" onkeyup="$('#video_passwordError').html('');" name="video_password" type="text" />
                          <span class="form_error_msg" id="video_passwordError"></span> 
                        </div>
                        <div _ngcontent-kgi-c53="" id="banner_img_preview" class="form-group ng-tns-c53-397"></div>
                        <div _ngcontent-kgi-c53="" class="form-group ng-tns-c53-397">
                        ...
                        <div _ngcontent-kgi-c53="" id="vertical_img_preview" class="form-group ng-tns-c53-397"></div>
                        <div _ngcontent-kgi-c53="" class="form-group ng-tns-c53-397">
                          ...
                          <input type="hidden" name="vertical_banner" id="vertical_banner" />
                          <span class="form_error_msg" id="vertical_bannerError"></span> 
                        </div>
                        <div _ngcontent-kgi-c53="" id="horizontal_img_preview" class="form-group ng-tns-c53-397"></div>
                         <div _ngcontent-kgi-c53="" class="form-group ng-tns-c53-397">
                          ...
                          <input type="hidden" name="horizontal_banner" id="horizontal_banner" />
                          <span class="form_error_msg" id="horizontal_bannerError"></span> 
                        </div>
                        
                        <button id="changePassBtn" class="btn btn-grey inner_page_btn">Submit</button>
                      </div>
                      <?php }else{ ?>
